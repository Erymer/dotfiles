...
layouts = [
    ...
    # layout.Columns(),
    # layout.Matrix(),
    layout.MonadTall(border_focus = aqua),
    # layout.MonadWide(),
    # layout.RatioTile(),
    # layout.Tile(),
    # layout.TreeTab(),
...
widget_defaults = {'font': 'Fira Mono Bold', 'fontsize': 14, 'padding': 8, 'foreground': white}
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Spacer(20),
                widget.TextBox("Brightness:", foreground=red, padding=0),
                widget.Backlight(backlight_name='intel_backlight', foreground=red, padding=0),
                widget.Spacer(20),
                widget.TextBox("Volume:", foreground=blue, padding=0),
                widget.Volume(foreground=blue, padding=0),
                widget.Spacer(20),
                widget.TextBox("Battery:", foreground=yellow, padding=0),
                widget.Battery(foreground=yellow, padding=0),
            ],
            24, background = black, opacity = 0.8,
        ),
        wallpaper='~/Images/Wallpapers/koiFish1920x1080.png',
        wallpaper_mode='fill',
    ),
